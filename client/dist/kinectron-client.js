...
var Kinectron = function Kinectron(arg1, arg2) {
  ...
  var DEPTHWIDTH = 320;
  var DEPTHHEIGHT = 288;
  var DEPTHWIDTHSM = 160;
  var DEPTHHEIGHTSM = 144; // Processing raw depth indicator
  ...
  this._processRawDepth = function (data) {
    ...
    for (var i = 0; i < imageData.data.length; i += 4) {
      var depth = imageData.data[i] * 255 + imageData.data[i + 1]; // var depth = (imageData.data[i + 1] << 8) + imageData.data[i]; //get uint16 data from buffer
  ...
  this._createMediaRecorder = function (frame) {
    ...
    if (frame == "color" || frame == "key") {
      ...
      newHiddenCanvas.width = DEPTHWIDTHSM;
      newHiddenCanvas.height = DEPTHHEIGHTSM;
    }
